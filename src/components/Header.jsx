...
import './Header.css';
import message from '../assets/message-circle-svgrepo-com.svg';

// Define a list of navigation items to be rendered in the center section
const navItems = [
  {
    icon: (
  ...
  return (
    <div className="container">
      ...
      <div className="avatar">
        <img src={Logo} id="logo" width={20} height={20} alt="Logo" />
      </div>
